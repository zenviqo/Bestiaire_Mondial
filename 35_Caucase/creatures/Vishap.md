---
nom_principal: Vishap
nom_original: վիշապ (višap, arménien classique) ; pluriel վիշապներ (višapner)
variantes_linguistiques:
  - arménien_classique: վիշապ (višap)
  - arménien_oriental: վիշապ (vichap)
  - arménien_occidental: վիշապ (vichab)
  - composé_lithique: վիշապաքար / vishapakar (pierre-vishap)
  - géorgien_voisin: ვეშაპი (vešapi, dragon / cétacé)
categorie: dragon des hauteurs et des sources / créature aquatique-orageuse / gardien des eaux
tradition: caucasienne
sous_tradition: arménienne (préchrétienne et chrétienne)
statut: validé
