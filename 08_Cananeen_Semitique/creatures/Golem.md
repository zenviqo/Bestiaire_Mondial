---
nom_principal: Golem
nom_original: גּוֹלֶם (golem)
variantes_linguistiques:
  - hebreu_biblique: golem (forme archaique unique attestation)
  - hebreu_medieval: golem
  - yiddish: goylem
  - judeo_arameen_kabbalistique: galma
categorie: créature artificielle / homme d'argile animé / serviteur ritualisé
tradition: cananeen_semitique
sous_tradition: judaisme rabbinique et kabbalistique medieval (Rhenanie, Boheme, Prague)
statut: validé
