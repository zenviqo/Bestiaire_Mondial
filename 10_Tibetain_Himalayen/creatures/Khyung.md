---
nom_principal: Khyung
nom_original: ཁྱུང་ (Wylie : khyung)
variantes_linguistiques:
  - tibétain_classique: ཁྱུང་ (khyung)
  - dzongkha: ཁྱུང་ (khyung)
  - sherpa: khyung
  - sikkimais: khyung
  - sanskrit_tibétanisé: mkha' lding (khading, "celui qui plane dans le ciel")
categorie: oiseau cosmique / monture des yidams / ennemi héréditaire des nāgas
tradition: tibétaine, himalayenne
sous_tradition: Bön, Nyingma, Kagyu
statut: validé
