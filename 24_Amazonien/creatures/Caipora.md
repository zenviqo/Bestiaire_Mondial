---
nom_principal: Caipora
nom_original: Caá-pora (tupi) / Caipora (portugais brésilien)
variantes_linguistiques:
  - tupi_ancien: Caá-pora, Caapora, Kaapora
  - portugais_brésilien: Caipora, Caiporinha, Caboclinho do Mato
  - guarani: Kaaguy-pora
  - régionalisme_du_Nordeste: Caipora-fêmea, Caipora-macho
categorie: esprit gardien de la forêt / petit génie tutélaire / punisseur des chasseurs
tradition: amazonienne (élargie au Brésil intérieur)
sous_tradition: tupi-guarani, folklore caboclo et sertanejo (Bahia, Goiás, Minas Gerais, São Paulo intérieur)
statut: validé
